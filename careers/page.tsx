...
export default function CareersPage() {
  ...
  const scrollToApplication = (jobId: string) => {
    ...
    if (applicationFormRef.current) {
      ...
      applicationFormRef.current.style.boxShadow = '0 0 20px rgba(249, 115, 22, 0.3)';
      setTimeout(() => {
        if (applicationFormRef.current) {
          applicationFormRef.current.style.boxShadow = '';
        }
      }, 2000);
    }
  };
  ...
  return (
    <div className="min-h-screen">
                    ...
                    <div className="flex space-x-2">
                      ...
                      >
                        {selectedJob === job.id 
                          ...
                          : getText('View Details', 'Ver Detalles')
                        }
                      </Button>
                      <Button 
      ...
      {/* Application Form */}
      <section ref={applicationFormRef} className="py-16 bg-background">
            ...
            <CardContent className="p-8">
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select defaultValue={selectedJob || ''}>
                    <SelectTrigger>
